...
import type { EnsayoDetail, CdPayload, SaveResponse } from '@/types'
...
export async function saveEnsayo(payload: CdPayload, ensayoId?: number): Promise<SaveResponse> {
...
export async function saveAndDownload(payload: CdPayload, ensayoId?: number): Promise<{ blob: Blob; filename?: string }> {
